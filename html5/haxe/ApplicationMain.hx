...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Nike Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Nike Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "568";
		app.meta["company"] = "JuniorNovoa and Bushtrain";
		app.meta["file"] = "Nike Engine";
		app.meta["name"] = "Friday Night Funkin' Nike Engine";
		app.meta["packageName"] = "com.juniorandbush.funkin";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' Nike Engine",
			width: 1280,
			x: null,
			y: null,
		};
